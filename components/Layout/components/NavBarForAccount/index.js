...
class IndexHeader extends React.Component {
	...
	render() {
		...
		return (
			<Header className="account-page-head page-head-small">
						...
						<div className="page-head-search maxWidth">
							...
							<div className="page-head-search-right">
								<Menu selectedKeys={[this.props.mainMenuIndex]} mode="horizontal" className="page-head-menu">
									<Menu.Item key="home">
										<Link href="/account/home"><a>我的首页</a></Link>
									</Menu.Item>
									<Menu.Item key="setting" className="subName">
										<Link href="/account/set-user/index"><a>账户设置</a></Link>
									</Menu.Item>
									<Menu.Item key="message" className="subName">
										<Link href="/account/message/inquiryMessage"><a>消息中心</a></Link>
									</Menu.Item>
								</Menu>
							</div>
						</div>
