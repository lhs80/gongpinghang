	...
	render() {
		...
		return (
			<Layout title="找回密码" className="register-wrapper">
				...
				<section>
					<Form className="registerForm mt8" style={{paddingTop: '60px'}}>
						...
						<div className="userWrapper mt5">
							...
							<FormItem className="OkBtn">
								<div className="regItem prl4">
									<Button type="primary" htmlType="submit" size="large" block className="bg-primary-linear border-circle regPassword mt2"
									        style={{height: '50px'}}
